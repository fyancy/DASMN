...
# NC
NC_0 = get_file(os.path.join(_dir, r'NC\0'))
NC_1 = get_file(os.path.join(_dir, r'NC\1'))
NC_2 = get_file(os.path.join(_dir, r'NC\2'))
NC_3 = get_file(os.path.join(_dir, r'NC\3'))
...
IF_7 = [get_file(os.path.join(_dir, f)) for f in IF_7_file]
IF_14 = [get_file(os.path.join(_dir, f)) for f in IF_14_file]
IF_21 = [get_file(os.path.join(_dir, f)) for f in IF_21_file]
...
OF_7 = [get_file(os.path.join(_dir, f)) for f in OF_7_file]
OF_14 = [get_file(os.path.join(_dir, f)) for f in OF_14_file]
OF_21 = [get_file(os.path.join(_dir, f)) for f in OF_21_file]
...
RoF_7 = [get_file(os.path.join(_dir, f)) for f in RoF_7_file]
RoF_14 = [get_file(os.path.join(_dir, f)) for f in RoF_14_file]
RoF_21 = [get_file(os.path.join(_dir, f)) for f in RoF_21_file]
