# DASMN
The PyTorch version for `Domain-adversarial similarity-based meta-learning network (DASMN)` in [Similarity-based meta-learning network with adversarial domain adaptation for cross-domain fault identification](https://www.sciencedirect.com/science/article/pii/S0950705121000927).
